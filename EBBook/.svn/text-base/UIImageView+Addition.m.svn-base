...
#define kImageViewWidth         200.0f
#define kBackViewColor          [UIColor colorWithWhite:0.16 alpha:0.7f]
...
{    
    ...
    CGRect rect = [self convertRect:self.bounds toView:self.window];
    NSLog(@"width is %f,height is %f ",self.bounds.size.width,self.bounds.size.height);
    imageView.frame = rect;
